...
<table id="Table_01" width="704" height="1057" border="0" cellpadding="0" cellspacing="0" style="color: #939598; background-color: #ffffff; font-size: 15px; line-height: 18px; font-family: verdana, arial, san-serif">
	<tr>
		<td colspan="11">
			<img border="0" src="http://sliding.osmprojects.com/assets/images/email-one/DYO_email-v3-1_01.jpg" width="704" height="59" alt=""></td>
	</tr>
	<tr>
		<td rowspan="8">
		...
		<td rowspan="2">
			<a href="https://www.facebook.com/TheSlidingDoorCo"><img
					<img border="0" src="http://sliding.osmprojects.com/assets/images/email-one/DYO_email-v3-1_06.jpg" width="28" height="46" alt=""></a>
		</td>
		<td rowspan="2">
		...
		<td rowspan="2">
			<a href="http://www.youtube.com/slidingdoorcompany/"><img
					<img border="0" src="http://sliding.osmprojects.com/assets/images/email-one/DYO_email-v3-1_08.jpg" width="72" height="46" alt=""></a>
		</td>
		<td rowspan="8">
