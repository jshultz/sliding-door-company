...
<table id="Table_01" width="704" height="1057" border="0" cellpadding="0" cellspacing="0" style="color: #939598; background-color: #ffffff; font-size: 15px; line-height: 18px; font-family: verdana, arial, san-serif">
	...
	<tr>
		<td rowspan="8">
			<img border="0" src="http://sliding.osmprojects.com/assets/images/email-one/DYO_email-v3-1_02.jpg" width="65" height="997" alt=""></td>
		<td>
		...
		<td>
			<a href="http://www.slidingdoorco.com/help/contact"><img
					<img border="0" src="http://sliding.osmprojects.com/assets/images/email-one/DYO_email-v3-1_04.jpg" width="81" height="45" alt=""></a>
		</td>
		<td colspan="4">
		...
		<td rowspan="2">
			<a href="https://www.facebook.com/TheSlidingDoorCo"><img
					<img src="http://sliding.osmprojects.com/assets/images/email-one/DYO_email-v3-1_06.jpg" width="28" height="46" alt=""></a>
		</td>
		<td rowspan="2">
			<a href="http://twitter.com/#!/slidingdoorco"><img border="0" src="http://sliding.osmprojects.com/assets/images/email-one/DYO_email-v3-1_07.jpg"
	...
	<tr>
		<td colspan="5">
			<img src="http://sliding.osmprojects.com/assets/images/email-one/DYO_email-v3-3_12.jpg" width="332" height="122" alt=""></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td colspan="2">
			<a href=""><img
					<img border="0" src="http://sliding.osmprojects.com/assets/images/email-one/DYO_email-v3-1_15.jpg" width="184" height="54" alt=""></a>
		</td>
		<td colspan="4">
	...
	<tr>
		<td colspan="9" style="background: url('/assets/images/email-one/DYO_email-v3-1_18.jpg');">
			<div style=" width: 530px; padding: 0 20px; font-size: 10px">
				<p>
					<a href="http://slidingdoorco.us5.list-manage1.com/subscribe/post?u=8f352881da294a071db8b8ed5&id=2d9fbec01c&MERGE0=<?php echo $cust_email;?>&MERGE1=<?php echo $firstname;?>&MERGE2=<?php echo $lastname;?>">SIGN UP FOR THE LATEST EVENTS AND OFFERS</a> | <a href="http://sliding.osmprojects.com/site/unsubscribe?email=<?php echo $cust_email ?>&key=<?php echo $key ?>">Unsubscribe</a>
				</p>
