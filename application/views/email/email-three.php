...
<table id="Table_01" width="704" height="1057" border="0" cellpadding="0" cellspacing="0" style="color: #939598; font-size: 15px; line-height: 18px; font-family: verdana, arial, san-serif">
	...
	<tr>
		<td colspan="9" style="background: url('/assets/images/email-one/DYO_email-v3-1_17.jpg')">
			<div style="width: 530px; padding: 0 20px; font-size: 12px; height: 84px; margin-top:20px;">
				<p>
				...
				<p style="font-size: 8px; line-height: 8px;">
					*Save 10% when you spend up to $1000. Save 15% when you spend over $1000. Save 20% when you spend over $2000. Discount applies to products offered
					...
					purchases. Discount valid for email recipient only, and expires on xx/xx/xx.
				</p>
			</div>
		</td>
	</tr>
