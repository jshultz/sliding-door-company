...
<table id="Table_01" width="704" height="1057" border="0" cellpadding="0" cellspacing="0" style="color: #939598; background-color: #ffffff; font-size: 15px; line-height: 18px; font-family: verdana, arial, san-serif">
	...
	<tr>
		<td rowspan="8">
			<img border="0" src="/assets/images/email-one/DYO_email-v3-1_02.jpg" width="65" height="997" alt=""></td>
		<td>
			<a href="http://www.slidingdoorco.com/showrooms"><img border="0" src="/assets/images/email-one/DYO_email-v3-1_03.jpg"
			                                                      width="96" height="45" alt=""></a></td>
		<td>
			<a href="http://www.slidingdoorco.com/help/contact"><img
					<img border="0" src="/assets/images/email-one/DYO_email-v3-1_04.jpg" width="81" height="45" alt=""></a>
		</td>
		<td colspan="4">
		...
		<td rowspan="2">
			<a href="https://www.facebook.com/TheSlidingDoorCo"><img
					<img src="/assets/images/email-one/DYO_email-v3-1_06.jpg" width="28" height="46" alt=""></a>
		</td>
		<td rowspan="2">
			<a href="http://twitter.com/#!/slidingdoorco"><img border="0" src="/assets/images/email-one/DYO_email-v3-1_07.jpg"
			                                                   width="24" height="46" alt=""></a>
		</td>
		<td rowspan="2">
			<a href="http://www.youtube.com/slidingdoorcompany/"><img
					<img src="/assets/images/email-one/DYO_email-v3-1_08.jpg" width="72" height="46" alt=""></a>
		</td>
		<td rowspan="8">
	...
	<tr>
		<td colspan="4" rowspan="2">
			<img src="/assets/images/email-one/DYO_email-v3-1_10.jpg" width="243" height="123" alt=""></td>
		<td colspan="2">
			<img src="/assets/images/email-one/DYO_email-v3-1_11.jpg" width="208" height="1" alt=""></td>
	</tr>
	<tr>
		<td colspan="5">
			<img src="/assets/images/email-one/DYO_email-v3-3_12.jpg" width="332" height="122" alt=""></td>
	</tr>
	<tr>
		<td colspan="9" style="background: url('/assets/images/email-one/DYO_email-v3-1_13.jpg')">
			<div style="">
				...
				<div style="width:240px; padding: 0 20px; float: right">
					...
					<a href="<?php echo $maplink;?>"><img border="0" width="150px" src="/assets/images/email-one/Google-Maps-Logo.png"></a>
	...
	<tr>
		...
		<td colspan="2">
			<a href=""><img
					<img border="0" src="/assets/images/email-one/DYO_email-v3-1_15.jpg" width="184" height="54" alt=""></a>
		</td>
		<td colspan="4">
			...
			<div style="width: 530px; padding: 0 20px; font-size: 12px; ">
				...
				<p style="font-size: 8px; line-height: 8px;">
					*Save 10% when you spend up to $1000. Save 15% when you spend over $1000. Save 20% when you spend over $2000. Discount applies to products offered
					...
					purchases. Discount valid for email recipient only, and expires on <?php echo date('Y-m-d', strtotime("+30 days")); ?>.
				</p>
			</div>
		</td>
	</tr>
	<tr>
		<td colspan="9" style="background: url('/assets/images/email-one/DYO_email-v3-1_18.jpg');">
			<div style=" width: 530px; padding: 0 20px; font-size: 10px">
				<p>
					<a href="http://slidingdoorco.us5.list-manage1.com/subscribe/post?u=8f352881da294a071db8b8ed5&id=2d9fbec01c&MERGE0=<?php echo $cust_email;?>&MERGE1=<?php echo $firstname;?>&MERGE2=<?php echo $lastname;?>">SIGN UP FOR THE LATEST EVENTS AND OFFERS</a> | <a href="site/unsubscribe?email=<?php echo $cust_email ?>&key=<?php echo $key ?>">Unsubscribe</a>
				</p>
	...
	<tr>
		<td colspan="9">
			<img src="/assets/images/email-one/DYO_email-v3-1_19.jpg" width="575" height="152" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="/assets/images/email-one/spacer.gif" width="65" height="1" alt=""></td>
		<td>
			<img src="/assets/images/email-one/spacer.gif" width="96" height="1" alt=""></td>
		<td>
			<img src="/assets/images/email-one/spacer.gif" width="81" height="1" alt=""></td>
		<td>
			<img src="/assets/images/email-one/spacer.gif" width="8" height="1" alt=""></td>
		<td>
			<img src="/assets/images/email-one/spacer.gif" width="58" height="1" alt=""></td>
		<td>
			<img src="/assets/images/email-one/spacer.gif" width="126" height="1" alt=""></td>
		<td>
			<img src="/assets/images/email-one/spacer.gif" width="82" height="1" alt=""></td>
		<td>
			<img src="/assets/images/email-one/spacer.gif" width="28" height="1" alt=""></td>
		<td>
			<img src="/assets/images/email-one/spacer.gif" width="24" height="1" alt=""></td>
		<td>
			<img src="/assets/images/email-one/spacer.gif" width="72" height="1" alt=""></td>
		<td>
			<img src="/assets/images/email-one/spacer.gif" width="64" height="1" alt=""></td>
	</tr>
</table>
